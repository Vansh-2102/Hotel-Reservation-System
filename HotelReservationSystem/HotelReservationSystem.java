...
public class HotelReservationSystem {
    ...
    private static final String password = "Vansh@2102";
    ...
    public static void main(String [] args) throws ClassNotFoundException, SQLException{
        ...
        try{
            ...
            while(true){
                ...
                System.out.println("4. Update Reserbvation");
    ...
    private static void viewReservations(Connection connection) throws SQLException {
        ...
        try (Statement statement = connection.createStatement();
            ...
            while (resultSet.next()) {
                ...
                System.out.printf("| %-14d | %-15s | %-11d | %-15s | %-20s |\n",
    ...
    private static void updateReservations(Connection connection , Scanner scanner){
        try{
            ...
            int reservationID = scanner.nextInt();
            scanner.nextLine();// Consumer teh newline character
            ...
            String sql = "UPDATE reservations SET gueat_name = '" + newGuestName +"',"+
    ...
    private static void deleteReservation(Connection connection, Scanner scanner){
        try{
            ...
            try(Statement statement = connection.createStatement()){
                ...
                if(affectedRows > 0){
                    System.out.println("Reservation deletes successfullu!");
                }else {
    ...
    private static boolean reservationExists(Connection connection, int reservationID) {
        try{
            ...
            e.printStackTrace();
            return false; // Handle database errors as neede
        }
    }
